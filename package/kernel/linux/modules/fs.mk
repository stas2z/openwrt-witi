...
define KernelPackage/fs-ufsd
  SUBMENU:=$(FS_MENU)
  TITLE:=NTFS ufsd driver for ASUS
  KCONFIG:= \
	CONFIG_UFSD_FS 
  FILES:= \
	$(LINUX_DIR)/fs/ufsd/ufsd.ko 
#\
#	$(LINUX_DIR)/fs/ufsd/ufsd_wrapper.ko
#  AUTOLOAD:=$(call AutoLoad,30,ufsd ufsd_wrapper,1)
  AUTOLOAD:=$(call AutoLoad,30,ufsd,1)
  $(call AddDepends/nls,utf8)
endef

define KernelPackage/fs-ufsd/description
 Kernel module for UFSD filesystem support
endef
