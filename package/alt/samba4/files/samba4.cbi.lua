...
tmpl = s:taboption("template", Value, "_tmpl",
	...
	translate("This is the content of the file '/etc/samba4/smb.conf.template' from which your samba configuration will be generated. " ..
...
function tmpl.cfgvalue(self, section)
	return nixio.fs.readfile("/etc/samba4/smb.conf.template")
end

function tmpl.write(self, section, value)
	value = value:gsub("\r\n?", "\n")
	nixio.fs.writefile("//etc/samba4/smb.conf.template", value)
end
